...
public class SendDNS {
	...
	public static String[] iterative(String nameserver, String hostname, String f){
		...
		for(int i = 0; i<parts.length; i++){
			...
			char c1 = p[2].charAt(0);
			char c2 = p[2].charAt(1);
			if(p[0].equals("A") && p[1].equals(hostname) && p[2].equals("null")) continue;
			...
			else if(p[0].equals("A") && (Character.isDigit(c1) && Character.isDigit(c2))){
				back[0] = p[2];
				back[1] = hostname;
				back[2] = "false";
				return back;
